...
- {id: ENET1_CLK_ROOT.outFreq, value: 50 MHz}
...
- {id: ENET_QOS_CLK_ROOT.outFreq, value: 125 MHz}
...
- {id: ENET_TIMER3_CLK_ROOT.outFreq, value: 50 MHz}
...
- {id: MIC_CLK_ROOT.outFreq, value: 228.7904/3 MHz}
...
- {id: PLL_AUDIO_CLK.outFreq, value: 686.3712 MHz}
...
- {id: ANADIG_PLL.PLL_AUDIO.denom, value: '100000', locked: true}
- {id: ANADIG_PLL.PLL_AUDIO.div, value: '28', locked: true}
- {id: ANADIG_PLL.PLL_AUDIO.num, value: '59880', locked: true}
- {id: ANADIG_PLL.PLL_AUDIO_POST_DIV.scale, value: '1', locked: true}
- {id: ANADIG_PLL.PLL_AUDIO_SS_DIV.scale, value: '100000'}
...
- {id: CCM.CLOCK_ROOT15.DIV.scale, value: '1', locked: true}
- {id: CCM.CLOCK_ROOT15.MUX.sel, value: ANADIG_OSC.OSC_24M}
- {id: CCM.CLOCK_ROOT16.DIV.scale, value: '1', locked: true}
...
- {id: CCM.CLOCK_ROOT57.DIV.scale, value: '10', locked: true}
- {id: CCM.CLOCK_ROOT57.MUX.sel, value: ANADIG_PLL.SYS_PLL1_DIV2_CLK}
- {id: CCM.CLOCK_ROOT6.DIV.scale, value: '4', locked: true}
- {id: CCM.CLOCK_ROOT6.MUX.sel, value: ANADIG_PLL.SYS_PLL2_CLK}
- {id: CCM.CLOCK_ROOT62.DIV.scale, value: '9', locked: true}
...
const clock_audio_pll_config_t audioPllConfig_BOARD_BootClockRUN =
    {
        ...
        .numerator = 59880,                       /* 30 bit numerator of fractional loop divider, Fout = Fin * ( loopDivider + numerator / denominator ) */
        .denominator = 100000,                    /* 30 bit denominator of fractional loop divider, Fout = Fin * ( loopDivider + numerator / denominator ) */
        .ss = NULL,                               /* Spread spectrum parameter */
        .ssEnable = false,                        /* Enable spread spectrum or not */
    };
...
void BOARD_BootClockRUN(void)
{
    ...
    */
    ...
    /* Configure ENET1 using SYS_PLL1_DIV2_CLK */
    ...
    /* Configure ENET_QOS using SYS_PLL1_DIV2_CLK */
    ...
    /* Configure ENET_TIMER3 using SYS_PLL1_DIV2_CLK */
    rootCfg.mux = kCLOCK_ENET_TIMER3_ClockRoot_MuxSysPll1Div2;
    rootCfg.div = 10;
