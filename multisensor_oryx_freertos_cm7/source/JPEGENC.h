...
#define JPEG_FILE_BUF_SIZE 128 //T.S. started at 2048. I think this can actually be near zero... because we're in buffer mode... not file mode.  but I haven't tried.
